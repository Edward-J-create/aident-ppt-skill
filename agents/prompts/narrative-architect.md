...
- Read `references/motion/themes-and-combinations.md` before selecting Dark or combined shots. Theme marks meaning, not mandatory alternation. Consider brand-title for an opening, aligned workflow rows for parallel processes and an actual table/list result within synthesis. All are optional; do not duplicate a result just to demonstrate another template.
